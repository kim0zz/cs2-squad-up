  ...
  return (
    <main className="min-h-screen">
      <div className="container max-w-2xl px-4 py-10">
        ...
        <Card className="bg-gradient-card border-border/80 p-6 sm:p-8 mt-8 space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Tutaj pojawią się cykliczne zbiórki piłkarskie.
          </p>
          <Button
            asChild
            className="w-full sm:w-auto h-11 sm:h-12 font-display text-base uppercase tracking-wider"
          >
